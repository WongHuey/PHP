...
?>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
		  ...
		  <!-- 新增 批发数量限制 begin --> 
<tr> 
<td class="label">最小购买数量：</td> 
<td><input type="text" name="min_number" value="<?php echo $this->_var['goods']['min_number']; ?>" size="20" />
<span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" mce_style="display: none;" <?php endif; ?> id="minNumber">该商品最小购买数量,0表示按购买数量无限制.</span>
</td>
</td>
</tr>
<!-- 批发数量限制 end -->
