...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th align="center">
      <input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox" /><a href="javascript:listTable.sort('order_sn', 'DESC'); "><?php echo $this->_var['lang']['order_sn']; ?></a><?php echo $this->_var['sort_order_sn']; ?>    </th>
    <th><a href="javascript:listTable.sort('add_time', 'DESC'); "></a>支付时间</th>
    <th><a href="javascript:listTable.sort('consignee', 'DESC'); "></a>客户名称 / 收件地址</th>
...
?>
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><input type="checkbox" name="checkboxes" value="<?php echo $this->_var['order']['order_sn']; ?>" /><a href="order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>" id="order_<?php echo $this->_var['okey']; ?>"><?php echo $this->_var['order']['order_sn']; ?><?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><br /><div align="center"><?php echo $this->_var['lang']['group_buy']; ?></div>
      <?php elseif ($this->_var['order']['extension_code'] == "exchange_goods"): ?><br /><div align="center"><?php echo $this->_var['lang']['exchange_goods']; ?></div><?php endif; ?></a></td>
    <td align="center"><?php echo $this->_var['order']['paymenttime']; ?></td>
    <td align="center" valign="middle"><?php echo htmlspecialchars($this->_var['order']['consignee']); ?> <br />
      <?php echo htmlspecialchars($this->_var['order']['address']); ?></td>
  
    <td align="center" valign="middle" nowrap="nowrap"><?php echo $this->_var['order']['formated_order_amount']; ?></td>
    <td align="center" valign="middle" nowrap="nowrap"><?php echo $this->_var['order']['paymentstatus']; ?></td>
    <td align="center" valign="middle"  nowrap="nowrap">
     ...
     <br />
     <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['order']['order_id']; ?>, remove_confirm, 'remove_order')"><?php echo $this->_var['lang']['remove']; ?></a>
     <?php endif; ?>
    </td>
  </tr>
