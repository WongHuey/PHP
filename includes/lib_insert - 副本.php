...
function insert_cart_info2()
{
    ...
    return '<a href="flow.php" title="' . $GLOBALS['_LANG']['view_cart'] . '"><font class=mecart>(' . $number .")<font class='ycmobile'> ". price_format($amount, false) . '</font></font></a>';
}
...
function insert_member_info8()
{
    ...
    $output = $GLOBALS['smarty']->fetch('library/member_info8.lbi');
 ...
 * @return  string
 */
function insert_in01()
{
$str = file('images/in01.html');
...
{    $count=$GLOBALS['db']->getOne('SELECT COUNT(*) FROM '.    $GLOBALS['ecs']->table('comment')."WHERE id_value='$arr[id]'".    "AND comment_type='$arr[type]' AND status = 1 AND parent_id = 0");    return $count;  
}

function insert_youtube8($arr) 
{  
...
if($countryCode == 'CN' && $arr[note]=="")
{
	return '';
}
else if($countryCode == 'CN' && $arr[note]!="")
{
	return '<div class=box08><div class=scale08><div class="kbl005"><img src=/images/video10.jpg width=100%></div></div></div>';

}
else if($arr[note]!="")
{
	return "<div class=box08><div class=scale08><iframe class=kbl005  src=https://www.youtube.com/embed/v8RlS0V2sOk?rel=0&controls=0&showinfo=0 frameborder=0 allowfullscreen></iframe></div></div>";
}
...
if($countryCode != 'CN')
{
	return '<div class=box08><div class=scale08><iframe class=kbl005  src=https://www.youtube.com/embed/IatrU6-21Ko?rel=0&controls=0&showinfo=0 frameborder=0 allowfullscreen></iframe></div></div>';

}
else
{
	return "<div class=box08><div class=scale08><div class=kbl005><img src=/images/video11.jpg width=100%></div></div></div>";
}
...
{
	//echo "<font color='blue'> $ip 在国内</font>";
	return '<img src=/images/v-del.jpg>';

}
else if($arr[note]!="")
{
	//echo "<font color='red'> $ip 在国外</font>";
	return "<div class=box08><div class=scale08>".$arr[note]."</div></div>";
}
...
//return "123";
if(is_mobile()) {
return "<div class='swiper-slide'><a href='/xr'><img src='/images/indexi/sj02.jpg' width='100%' alt='xr brazilian hair'></a></div><div class='swiper-slide'><a href='/wholesale-hair'><img src='/images/indexi/sj03.jpg' width='100%'></a></div><div class='swiper-slide'><a href='/brazilian-hair'><img src='/images/indexi/sj01.jpg'  width='100%'></a></div>";
}else {    
return "<div class='swiper-slide'><a href='https://api.whatsapp.com/send?phone=8613822134401' target='_blank'><img src='/images/indexi/ban66.jpg' width='100%' alt='kbl hair factory'></a></div><div class='swiper-slide'><a href='#'><img src='/images/indexi/ban67.jpg' width='100%'></a></div><div class='swiper-slide'><a href='#'><img src='/images/indexi/ban68.jpg' width='100%'></a></div>";
}
}
