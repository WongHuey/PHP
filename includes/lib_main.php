    ...
    if ($filename != 'index')
    {
        ...
        else
        {
            ...
            if ('group_buy' == $filename)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a href="group_buy.php">' .
            ...
            elseif ('auction' == $filename)
            {
                ...
                $args       = array('auid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a href="auction.php">' .
            ...
            elseif ('snatch' == $filename)
            {
                ...
                $args       = array('id' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span><a href="snatch.php">' .                                 $GLOBALS['_LANG']['snatch_list'] . '</a>';
            }
            /* 批发 */
            elseif ('wholesale' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a href="wholesale.php">' .
            ...
            elseif ('exchange' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a href="exchange.php">' .
