...
function insert_cart_info2()
{
    ...
    return '<span class=mecart>' . $number .'</span>';
}
...
{
	return '<div class=box08><div class=scale08><div class="kbl005"><img src=/images/about/youtube-fail.jpg width=100%></div></div></div>';

}
else if($arr[note]!="")
{
	return "<div class=box08><div class=scale08><iframe class=kbl005  src=https://www.youtube.com/embed/-fJkVM6724o?rel=0&controls=0&showinfo=0 frameborder=0 allowfullscreen></iframe></div></div>";
}
...
//return "123";
if(is_mobile()) {
return "<div class='swiper-slide'><a href='/xr'><img src='/images/indexi/sj-xrhair.webp' width='100%' alt='xr brazilian hair'></a></div><div class='swiper-slide'><a href='/wholesale-hair'><img src='/images/indexi/sj-wholesale.webp' width='100%'></a></div><div class='swiper-slide'><a href='/brazilian-hair'><img src='/images/indexi/sj-brazilian.webp'  width='100%'></a></div>";
}else {    
