...
function assign_ur_here($cat = 0, $str = '')
{
   ...
   // $page_title = $GLOBALS['_CFG']['shop_title'] . '' . '';
    ...
    $ur_here    = '<a href="." class="">' . $GLOBALS['_LANG']['home'] . '</a>';
    ...
    if ($filename != 'index')
    {
				...
				$page_title =htmlspecialchars($val['cat_name']) . '-' . $page_title;
				 ...
				 /* 获取自定义标题 */
				  ...
				  //$page_title = htmlspecialchars($val['cat_name']) . '|' . $page_title;
                    ...
                    $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="text-capitalize" href="' . build_uri($type, $args, $val['cat_name']) . '">' .
        ...
        else
        {
            ...
            if ('group_buy' == $filename)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-capitalize" href="group_buy.php">' .
            ...
            elseif ('auction' == $filename)
            {
                ...
                $args       = array('auid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-capitalize" href="auction.php">' .
            ...
            elseif ('snatch' == $filename)
            {
                ...
                $args       = array('id' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span><a class="font-additional font-weight-normal color-main text-capitalize" href="snatch.php">' .                                 $GLOBALS['_LANG']['snatch_list'] . '</a>';
            }
            /* 批发 */
            elseif ('wholesale' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-capitalize" href="wholesale.php">' .
            ...
            elseif ('exchange' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-capitalize" href="exchange.php">' .
    ...
    if (!empty($str))
    {
       // $page_title  = $str . '_' . $page_title;
        ...
        $ur_here    .= ' <span><i class="fa fa-angle-double-right"></i> </span> <font class="text-capitalize">' . $str .'</font>';
    }
