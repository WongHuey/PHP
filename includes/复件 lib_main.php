...
function assign_ur_here($cat = 0, $str = '')
{
   ...
   // $page_title = $GLOBALS['_CFG']['shop_title'] . '' . '';
    ...
    $ur_here    = '<a href="." class="font-additional font-weight-normal color-main2 text-uppercase">' . $GLOBALS['_LANG']['home'] . '</a>';
    ...
    if ($filename != 'index')
    {
        ...
        if (in_array($filename, array('category', 'goods', 'article_cat', 'article', 'brand')))
        {
            ...
            if (!empty($cat_arr))
            {
                ...
                foreach ($cat_arr AS $val)
                {
				 ...
				 if($val['cat_title']!="" && 'category' == $filename)
				 {
				 ...
				 if($val['cat_id']=="5")
				 {
				// $page_title="Brazilian Body Wave Hair,cheap human hair extensions online";
				 }
				 
				 else if($val['cat_id']=="21")
				 {
				// $page_title="Deep Wave Human Hair,cheap brazilian hair extensions online";
				 }
				 
				 else if($val['cat_id']=="23")
				 {
				// $page_title="Brazilian Hair Straight Weave,cheap brazilian hair extensions online";
				 }
				 
				 else if($val['cat_id']=="20")
				 {
				// $page_title="Brazilian Curly Hair Weave,cheap brazilian hair extensions online";
				 } 
				 
				 
				 else if($val['cat_id']=="3")
				 {
				// $page_title="peruvian body wave|peruvian virgin hair weave - kabeilu";
				 }
				 
				 else if($val['cat_id']=="14")
				 {
				// $page_title="peruvian straight|peruvian virgin hair weave - kabeilu";
				 }
				 
				 else if($val['cat_id']=="11")
				 {
				// $page_title="lace front closure body wave|remy lace closure - kabeilu";
				 }
				 
				 else if($val['cat_id']=="24")
				 {
				// $page_title="cheap lace closure deep wave|remy lace closure - kabeilu";
				 }
				 ...
				 {
				 //$zdytitle=htmlspecialchars($val['cat_name']);
				...
				$page_title =htmlspecialchars($val['cat_name']) . '-' . $page_title;
				 ...
				 /* 获取自定义标题 */
				  ...
				  //$page_title = htmlspecialchars($val['cat_name']) . '|' . $page_title;
                    ...
                    $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main2 text-uppercase" href="' . build_uri($type, $args, $val['cat_name']) . '">' .
        ...
        else
        {
            ...
            if ('group_buy' == $filename)
            {
                ...
                $args       = array('gbid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-uppercase" href="group_buy.php">' .
            ...
            elseif ('auction' == $filename)
            {
                ...
                $args       = array('auid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-uppercase" href="auction.php">' .
            ...
            elseif ('snatch' == $filename)
            {
                ...
                $args       = array('id' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span><a class="font-additional font-weight-normal color-main text-uppercase" href="snatch.php">' .                                 $GLOBALS['_LANG']['snatch_list'] . '</a>';
            }
            /* 批发 */
            elseif ('wholesale' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-uppercase" href="wholesale.php">' .
            ...
            elseif ('exchange' == $filename)
            {
                ...
                $args       = array('wsid' => '0');
                $ur_here   .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a class="font-additional font-weight-normal color-main text-uppercase" href="exchange.php">' .
	...
	//if ($filename == 'category-2') $page_title="123";
    ...
    if (!empty($str))
    {
       // $page_title  = $str . '_' . $page_title;
		//$page_title  = $str . '-' . $page_title;
            ...
            if ('goods' == $filename)
            {
			$page_title  = $str . '-KBL Virgin Hair';
			//$page_title  = $str;
			}
			else
			{
        ...
        $ur_here    .= ' <span><i class="fa fa-angle-double-right"></i> </span> ' . $str;
    }
...
function get_parent_cats($cat)
{
    ...
    $arr = $GLOBALS['db']->GetAll('SELECT cat_title,cat_id, cat_name, parent_id FROM ' . $GLOBALS['ecs']->table('category'));
...
function build_urhere($arr, $type = 'category')
{
    ...
    foreach ($arr AS $val)
    {
        ...
        $str .= ' <span><i class="fa fa-angle-double-right"></i> </span> <a href="' . build_uri($type, $args). '">' . htmlspecialchars($val['cat_name']) . '</a>';
    }
