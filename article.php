...
if($cat_id02==4 || $cat_id02==15)
{
Header("Location: /blog.php?id=".$article_id."");
exit;
}
...
if (!$smarty->is_cached('article.dwt', $cache_id))
{
	...
	$smarty->assign('get_url',$row['open_type'] != 1 ? build_uri('article', array('aid'=>$article_id), $article['title']) : trim($row['file_url']));
