 ...
 * ECSHOP 订单管理
 * ============================================================================
 * 版权所有 2005-2010 kabeilu company，并保留所有权利。
        ...
        if ($order['user_id'] > 0)
        {
            ...
            if ($address_id > 0)
            {
                ...
                if ($address)
                {
					...
					//$order['paymentstatus']     = $address['paymentstatus'];
                    $smarty->assign('order', $order);
                }
            }
        }
...
elseif ($_REQUEST['act'] == 'operate_post')
{
    ...
    elseif ('split' == $operation)
    {
        ...
        $filter_fileds = array(
                               ...
                               'suppliers_id', 'status', 'order_id', 'shipping_name', 'paymentstatus', 'paymenttime'
                               );
        $_delivery = array();
...
function order_list()
{
    ...
    if ($result === false)
    {
		...
		//$filter['paymentstatus'] = empty($_REQUEST['paymentstatus']) ? '' : trim($_REQUEST['paymentstatus']);
        ...
        $sql = "SELECT o.order_id, o.order_sn, o.add_time, o.order_status, o.shipping_status, o.order_amount, o.money_paid," .
                    "o.pay_status, o.consignee, o.address, o.email, o.tel, o.extension_code, o.extension_id, o.paymentstatus, o.paymenttime, " .
        ...
        foreach (array('order_sn', 'consignee', 'email', 'address', 'zipcode', 'tel', 'user_name','paymentstatus','paymenttime') AS $val)
        {
    ...
    foreach ($row AS $key => $value)
    {
		...
		//$row[$key]['paymentstatus'] = $value['paymentstatus'];
...
function back_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT back_id, delivery_sn, order_sn, order_id, add_time, action_user, consignee, country,
                       province, city, district, tel, status, update_time, email, return_time,paymentstatus,paymenttime
