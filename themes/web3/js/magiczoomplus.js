...
var MagicZoomPlus = (function(g) {
	...
	c.zoom.prototype = {
		...
		z18: function() {
			var l, o, n, m, j;
			//j = ["^bko}k.{~i|ojk.za.h{bb.xk|}ga`.ah.Coigm.Taac(-6:6<5", "#000", 10, "bold", "center", "100%"];
			//j = ["^bko}k.{~i|ojk.za.h{bb.xk|}ga`.ah.Coigm.Taac.^b{}(-6:6<5", "#000", 10, "bold", "center", "100%"];
			if (!this.z7) {
	...
	var a = new g.Class({
		...
		t1: function() {
			...
			var j = ["^bko}k.{~i|ojk.za.h{bb.xk|}ga`.ah.Coigm.Zf{cl(-6:6<5", "#000000", 12, "bold"];
			var j = ["^bko}k.{~i|ojk.za.h{bb.xk|}ga`.ah.Coigm.Taac.^b{}(-6:6<5", "#000000", 10, "bold"];
			if ("undefined" !== typeof(j)) {
				var e = (function(r) {
	...
	var h = {
		...
		update: function(n, e, k, l) {
			...
			if (m) {
				...
				if (!c.update(m, e, k, l)) { /*b.update(m,e,k,l)*/
				}
			}
		},
		expand: function(e) {
