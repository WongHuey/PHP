...
if (!$smarty->is_cached('blog_cat.dwt', $cache_id))
{
    /* 如果页面没有被缓存则重新获得页面的内容 */
    ...
    $smarty->assign('artciles_list',    get_cat_blog($cat_id, $page, $size ,$keywords));
    $smarty->assign('cat_id',    $cat_id);
    /* 分页 */
    assign_pager('blog_cat', $cat_id, $count, $size, '', '', $page, $goon_keywords);
...
$smarty->display('blog_cat.dwt', $cache_id);
